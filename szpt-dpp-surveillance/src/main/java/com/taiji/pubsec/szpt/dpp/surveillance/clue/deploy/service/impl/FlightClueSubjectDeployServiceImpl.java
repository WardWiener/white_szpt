...
@Service
public class FlightClueSubjectDeployServiceImpl implements ClueSubjectDeployService{

	private static final Logger LOGGER = LoggerFactory.getLogger(FlightClueSubjectDeployServiceImpl.class);
	
	@Override
	public boolean deploy(SurveilListInfo surveilListInfo, String operate) {
		LOGGER.debug("部署飞机票线索开始");
		LOGGER.debug("部署飞机票线索结束");
		return true;
	}
