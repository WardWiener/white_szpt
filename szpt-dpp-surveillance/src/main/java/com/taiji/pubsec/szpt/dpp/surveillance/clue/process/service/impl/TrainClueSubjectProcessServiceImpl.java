...
@Service("trainClueSubjectProcessService")
public class TrainClueSubjectProcessServiceImpl extends AbstractClueSubjectProcessServiceImpl{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(TrainClueSubjectProcessServiceImpl.class);

	@Override
	public boolean support(ClueInfo clueInfo) {
		if(clueInfo instanceof TrainInfo){
			return true ;
		}
		return false;
	}
