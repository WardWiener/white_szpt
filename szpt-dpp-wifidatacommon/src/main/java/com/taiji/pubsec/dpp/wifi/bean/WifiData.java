...
public class WifiData implements Serializable{
	...
	private String gatherTime;//上线时间
	...
	private int noupdateCount = 0;//未更新的次数
	 ...
	 * @param longitude 经度
	 * @param latitude 纬度
	 * @param gatherTime 设备采集时间
	 */
	public WifiData(String mac, String enterTime, String leaveTime,
			String placeId, String longitude, String latitude, String gatherTime) {
		super();
		this.mac = mac;
		this.enterTime = enterTime;
		this.leaveTime = leaveTime;
	...
	public void setNoupdateCount(int noupdateCount) {
		this.noupdateCount = noupdateCount;
	}

	@Override
	public String toString() {
		return "WifiData [id=" + id + ", mac=" + mac + ", enterTime=" + enterTime + ", leaveTime=" + leaveTime
				+ ", gatherTime=" + gatherTime + ", createTime=" + createTime + ", placeId=" + placeId + ", placeName="
				+ placeName + ", latitude=" + latitude + ", longitude=" + longitude + ", idcode=" + idcode
				+ ", fiveColorPersonName=" + fiveColorPersonName + ", peopleType=" + peopleType + ", warnType="
				+ warnType + ", noupdateCount=" + noupdateCount + ", residentialArea=" + residentialArea + ", theft="
				+ theft + "]";
	}
