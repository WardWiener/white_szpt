 ...
 * All right reserved.
 * 
 * Created on 2015年10月19日 下午5:11:17
 */
package com.taiji.pubsec.szpt.dpp.wififilerecv;
...
public class Bootstrap {
    ...
    private static String[] configpaths = new String[]{"classes/appContext-*.xml"} ;
    ...
    private static void generatePid(){
    	try{
    		String runClassPath = Bootstrap.class.getClassLoader().getResource("").getPath() ;
