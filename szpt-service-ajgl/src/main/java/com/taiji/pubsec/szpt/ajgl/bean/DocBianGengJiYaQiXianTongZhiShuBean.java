...
public class DocBianGengJiYaQiXianTongZhiShuBean {
	...
	private String a13;	//原羁押期限起（第一联）
	
	private String a14;	//原羁押期限止（第一联）
	
	private String a15;	//变更原因（第一联）
	
	private String a16;	//现羁押期限起（第一联）
	
	private String a17;	//现羁押期限止（第一联）
	...
	private String b16;	//羁押时间起（第二联）
	
	private String b17;	//羁押时间止（第二联）
	
	private String b18;	//文书时间（第二联）
	...
	private String c16;	//羁押时间起（第三联）
	
	private String c17;	//羁押时间止（第三联）
	
	private String c18;	//文书时间（第三联）
	...
	private String d16;	//羁押时间起（第四联）
	
	private String d17;	//羁押时间止（第四联）
	
	private String d18;	//文书时间（第四联）
