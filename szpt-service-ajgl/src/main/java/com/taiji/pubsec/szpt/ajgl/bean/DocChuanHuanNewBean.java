...
/**
 * (行政)传唤证 DOC_XZ004_NEW Bean
 */
public class DocChuanHuanNewBean {
	...
	private String b12;	//期限日期							
	
	private String b13;	//派出所名称						
	
	private String b14;	//公安机关印章(签发日期)					
