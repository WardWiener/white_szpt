...
public class DocChuanHuanNewXingShi2012Bean {
	...
	private String a11;	//出生日期(第一联)
	
	private String a12;	//住址(第一联)
	
	private String a13;	//单位及职业(第一联)
	
	private String a14;	//传唤原因(第一联)
	
	private String a15;	//指定拘留时间(第一联)
	
	private String a16;	//指定拘留地点(第一联)
	
	private String a17;	//批准人A17(第一联)
	
	private String a18;	//批准时间(第一联)
	
	private String a19;	//办案人A19(第一联)
	
	private String a20;	//办案人A20(第一联)
	
	private String a21;	//办案单位(第一联)
	
	private String a22;	//填发时间(第一联)
	...
	private String b7;	//涉嫌XX罪(第二联)
	
	private String b8;	//犯罪嫌疑人(第二联)
	
	private String b9;	//性别(第二联)
	
	private String b10;	//出生日期(第二联)
	
	private String b11;	//住址(第二联)
	
	private String b12;	//于X到(第二联)
	
	private String b13;	//到XX接受讯问(第二联)
	
	private String b14;	//日期(第二联)
	...
	private String c7;	//涉嫌XX罪(第二联)
	
	private String c8;	//犯罪嫌疑人(第二联)
	
	private String c9;	//性别(第二联)
	
	private String c10;	//出生日期(第二联)
	
	private String c11;	//住址(第二联)
	
	private String c12;	//于X到(第二联)
	
	private String c13;	//到XX接受讯问(第二联)
	
	private String c14;	//日期(第二联)
