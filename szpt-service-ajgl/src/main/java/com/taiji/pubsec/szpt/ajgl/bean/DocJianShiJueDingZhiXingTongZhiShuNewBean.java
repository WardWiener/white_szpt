...
public class DocJianShiJueDingZhiXingTongZhiShuNewBean {
	...
	private String a9; // 被监视居住人(第一联)

	private String a10; // 被监视居住人性别(第一联)

	private String a11; // 被监视居住人出生日期(第一联)

	private String a12; // 住址(第一联)

	private String a13; // 单位及职业(第一联)

	private String a14; // 监视居住原因(第一联)

	private String a16; // 是否指定居所(第一联)

	private String a15; // 监视居住地点(第一联)

	private String a17; // 起算时间(第一联)

	private String a18; // 执行机关(第一联)

	private String a19; // 批准人(第一联)

	private String a20; // 批准时间(第一联)

	private String a21; // 办案人(第一联)

	private String a22; // 办案单位(第一联)

	private String a23; // 填发人(第一联)

	private String a24; // 填发时间(第一联)

	private String a25; // 办案人2
	...
	private String b12; // 因XXX(第二联)

	private String b13; // 第XX条(第二联)

	private String b14; // 决定在XXX(第二联)

	private String b15; // 从日期(第二联)

	private String b16; // 日期(第二联)

	private String b17; // XX案

	private String b18; // 监视居住/指定居所监所居住(第二联)

	private String b19; // 由XX负责
	...
	private String c17; // 从日期(第二联)

	private String c18; // 日期(第三联)

	private String c12; // XX案(第三联)

	private String c13; // 因XX(第三联)

	private String c10; // 住址(第三联)

	private String c11; // 单位及职业(第三联)

	private String c14; // 第XX条(第三联)

	private String c15; // 决定在XX(第三联)

	private String c16; // 由XX(第三联)

	private String c19; // 监视居住/指定居所监所居住(第三联)
	...
	private String d7; // XX名称(第四联)

	private String d8; // 因XX(第四联)

	private String d9; // 决定在XX(第四联)

	private String d10; // 犯罪嫌疑人(第四联)

	private String d11; // 性别(第四联)

	private String d12; // 出生日期(第四联)

	private String d13; // 住址(第四联)

	private String d14; // 从日期(第四联)

	private String d15; // 日期(第四联)

	private String d16; // XX罪(第四联)

	private String d17; // 是否属于限制律师会见的三类特殊案件(第四联)

	private String d19; // 监视居住/指定居所监所居住(第四联)
