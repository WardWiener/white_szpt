...
public class DocLiAnJueDingShuNewBean {
	...
	private String a11;	//犯罪嫌疑人出生日期(第一联)					
	...
	private String b9;	//日期(第二联)	
	
	//省外立案决定书扫描件
	
	private String swlasj;			//省外案件立案时间
	...
	public String getSwlasj() {
		return swlasj;
	}

	public void setSwlasj(String swlasj) {
		this.swlasj = swlasj;
	}
