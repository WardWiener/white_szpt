...
public class DocZeLingSheQuJieDuSheQuKangFuJueDingShuNewBean {
	...
	private String a14; //强制隔离戒毒期限(开始)
	...
	private String b15; //延长强制隔离戒毒日期(开始)
	
	private String b16; //延长强制隔离戒毒(结束)
	...
	private String b21; //被责令社区戒毒/社区康复人签名时间
