...
/**
 * (刑事)传唤证 DOC_XS_XZ_CHZ_NEW
 * @author chengkai
 */
@Entity
@Table(name = "t_ajgl_doc_chz_new_2012_xs")
public class DocChuanHuanNewXingShi2012 {
	...
	@Temporal(TemporalType.TIMESTAMP)
	private Date b10;	//出生日期(第二联)
	
	private String b11;	//住址(第二联)
	
	@Temporal(TemporalType.TIMESTAMP)
	private Date b12;	//于X到(第二联)
	...
	@Temporal(TemporalType.TIMESTAMP)
	private Date c10;	//出生日期(第二联)
	
	private String c11;	//住址(第二联)
	
	@Temporal(TemporalType.TIMESTAMP)
	private Date c12;	//于X到(第二联)
	
	private String c13;	//到XX接受讯问(第二联)
	
	@Temporal(TemporalType.TIMESTAMP)
	private Date c14;	//日期(第二联)
