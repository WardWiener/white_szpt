 ...
 */
@Entity
@Table(name = "t_ajgl_doc_jsjzjdzxtzs_new")
public class DocJianShiJueDingZhiXingTongZhiShuNew {
	...
	private Date a11;	//被监视居住人出生日期(第一联)					
	...
	@Temporal(TemporalType.TIMESTAMP)
	private Date c17;	//从日期(第二联)
	
	@Temporal(TemporalType.TIMESTAMP)
	private Date c18;	//日期(第三联)	
	...
	@Temporal(TemporalType.TIMESTAMP)
	private Date d12;	//出生日期(第四联)
	
	private String d13;	//住址(第四联)
	
	@Temporal(TemporalType.TIMESTAMP)
	private Date d14;	//从日期(第四联)
