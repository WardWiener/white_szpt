...
public class HighriskPersonAnalyzeServiceTestCase extends TestBase{
	private final static Logger LOGGER = LoggerFactory.getLogger(HighriskPersonAnalyzeServiceTestCase.class);
	...
	@Test
	@DatabaseSetup("classpath:dataset/service/highriskPersonAnalyzeService/findHPersonsCountByPeopleTypeByDayPart-setup.xml")
	public void testFindHPersonsCountByPeopleTypeByDayPart() {
		...
		List<AlarmInfo> alarmInfoLst = highriskPersonAnalyzeService.findHPersonsCountByPeopleTypeByDayPart(startDay, endDay, peopleTypeCodes);
