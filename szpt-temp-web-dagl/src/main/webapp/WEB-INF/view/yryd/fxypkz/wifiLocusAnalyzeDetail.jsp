...
<p class="mar-top font12 color-gray2">
	保存快照原因：<span id="intro"></span><!-- <span class="color-green1">已推送办案民警</span><span
		class="color-orange1">办案民警未查看</span> -->
</p>

	<div class="row row-mar" style="margin-top: 20px">
	<div class="col-xs-3" style="width:225px;"> <label class="control-label">身份证号&nbsp;/&nbsp;手机号&nbsp;/&nbsp;MAC地址：</label></div>
		...
		<div class="col-xs-3 row-mar" style="width: 350px">			
			...
			<button id="recentlySixMonth" class="btn btn-primary btn-sm timeBtn">近半年</button>
		</div>
		<div class="col-xs-10" style="width: 470px; ">
			<div class="col-xs-3 input-group">
				&nbsp&nbsp&nbsp<label> <span id="zdySpan" style="display:none;">自定义</span>时间：</label>
			</div>
...
<script type="text/javascript"
	src="<%=context%>/scripts/yryd/fxypkz/wifiLocusAnalyzeDetial.js"></script>
</html>