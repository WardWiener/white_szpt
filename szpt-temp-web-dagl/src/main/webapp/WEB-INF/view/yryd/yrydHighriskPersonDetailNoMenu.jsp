...
<body style="background: #132643;margin:20px;">
		...
		<div id="c-center-right">
			<div class="m-ui-title1">
				...
				<div style="margin-right: 120px;">
					...
					<!--户籍与暂住end-->
					<div class="main-block" id="bs-scroll-5" style="min-height: 40px;">
						<div class="m-ui-title3">
							<h2>
					...
					<div class="main-block light-block-er" id="bs-scroll-6">
						<div class="m-ui-title3">
							<h2>
					...
					<div class="main-block" id="bs-scroll-8" style="display:none;">
						<div class="m-ui-title3">
							<h2>
					...
					<div class="main-block" id="bs-scroll-10">
						<div class="m-ui-title3">
							<h2>
					...
					<div class="main-block" id="bs-scroll-11">
						<div class="m-ui-title3">
							<h2>
					...
					<div class="main-block" id="bs-scroll-12">
						<div class="m-ui-title3">
							<h2>
				...
				<div style="position: fixed; right: 20px; top: 175px;">
					<div class="history-content history-content-xs" id="navbar-example">
						<ul class="nav nav-tabs" role="tablist"
							...
							<li><span class="icon-red-dot"></span><a href="#bs-scroll-8"
								class="con-box"><span class="arrow"></span>轨迹信息</a></li>
							<li><span class="icon-red-dot"></span><a href="#bs-scroll-9"
								class="con-box"><span class="arrow"></span>出行信息</a></li>
							<li><span class="icon-red-dot"></span><a
								href="#bs-scroll-10" class="con-box"><span class="arrow"></span>旅馆住宿</a></li>
							<li><span class="icon-red-dot"></span><a
								href="#bs-scroll-11" class="con-box"><span class="arrow"></span>网吧上网</a></li>
