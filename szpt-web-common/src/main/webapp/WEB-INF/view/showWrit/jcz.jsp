...
<body class="m-ui-layer-body">
	...
	<div style="padding: 20px;" >
		<div id="writ1" style="width: 600px; MARGIN-RIGHT: auto; MARGIN-LEFT: auto;" class="writDiv m-ui-layer-content">
			...
			<br/>
			<p>拘传原因 <span class="valCell" valName="a14"></span></p>
			<br/>
			<p>批准人   <span class="valCell" valName="a15"></span></p>
			<br/>
			<p>批准时间   <span class="valCell" valName="16"></span></p>
			<br/>
		...
		<div id="writ2" style="display: none; width: 600px; MARGIN-RIGHT: auto; MARGIN-LEFT: auto;" class="writDiv m-ui-layer-content">
			...
			<br/>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根据《中华人民共和国刑事诉讼法》第六十四条之规定，兹决定对犯罪嫌疑人<span class="valCell" valName="b9"></span>（性别<span class="valCell" valName="b10"></span>，出生日期 <span class="valCell" valName="b11"></span>，住址
				 <span class="valCell" valName="b12"></span>)执行拘传。</p>
			<br>
			<br>
			<p style="text-align: right;">(公安局印)</p>
			<p style="text-align: right;"> <span class="valCell" valName="b13"></span></p>
			<br/>
			<br/>
			<br/>
			<br/>
			<p>本证已于______年______月______日_____时向我宣布。</p>
			<br/>
			<p style="text-align: right;">被拘传人：____________(捺指印)</p>	
			<br/>
			<p>拘传到案时间______年______月______日______时。</p>
			<br/>
			<p style="text-align: right;">被拘传人：____________(捺指印)</p>		    
			<br/>
			<p>拘传结束时间______年______月______日______时。</p>
			<br/>
			<p style="text-align: right;">被拘传人：____________(捺指印)</p>		    
			<br/>
			<br/>
...
<script type="text/javascript"
	src="<%=context%>/scripts/showWrit/jcz.js"></script>
</html>