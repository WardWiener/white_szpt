...
<h1 class="nav-father">实战平台</h1> 
		...
		<div id="accordion" class="m-ui-accordion">
			...
			<d:ss resource="${pageContext.request.contextPath}/yayd/showYaydListPage.action" type="h3" request="${pageContext.request}"
				otherAttribute='myHref="${pageContext.request.contextPath}/loginHomePage/showLoginPage.action"'
				value='<span class="leftmenu-icon"></span><span class="moveSpan"><a><span class="leftH3Span">自定义界面</span></a></span>' />
