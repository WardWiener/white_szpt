...
<body style="background: #1E2B42;">
	...
	<p class="mar-top font12 color-gray2">
		保存快照原因：<span id="trackAnalyzeSnapshotInfo"></span><!-- <span class="color-green1">已推送办案民警</span><span
	...
	<div class="row">
		<div class="col-xs-8">
			<div class="history-content" style="max-height: 840px; overflow: auto">
		...
		<div class="row mar-top">
			<div class="col-xs-8">
				...
				<div class="col-xs-6">
					<div id="locusPointMapConten"
						style="margin-right: 1px; height: 200px; overflow: hidden;">
					</div>
				</div>
				<div class="col-xs-6">
					<div id="locusMapConten"
						style="margin-right: 1px; height: 200px; overflow: hidden;">
					</div>
				</div>
			</div>
...
<script type="text/javascript"
	src="<%=context%>/scripts/yryd/fxypkz/trackAnalyzeDetail.js"></script>
</html>
