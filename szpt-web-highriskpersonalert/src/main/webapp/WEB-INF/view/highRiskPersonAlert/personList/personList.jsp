...
<body>
<input id="isApprove" style="display:none" value="0">
						...
						<div class="right-inner">
							<div class="m-ui-searchbox">
								...
								<div class="row row-mar">
									...
									<div class="col-xs-2 text-right"><button id="add"class="btn btn-primary" ><span class="glyphicon glyphicon-plus mar-right"></span>新增高危人</button></div>
								</div>
							...
							<div id="examineStateDiv" class="row">
							<div class="col-xs-2" style="width:100px;"> <label class="control-label">审批状态：</label></div>
							<div class="col-xs-10">
							<div class="row m-icheck-group">
							            <p class="col-xs-1" style="width:150px"><input id="allCzzt" value=""type="checkbox" class="icheckbox">全部</p>
							            <p class="col-xs-1" style="width:150px"><input value="<%= com.taiji.pubsec.szpt.highRiskPersonAlert.action.util.Constant.CZZT_XZ%>"type="checkbox"  class="icheckbox czztCheck"name="czzt">新增</p>
							            <p class="col-xs-1" style="width:150px"><input value="<%= com.taiji.pubsec.szpt.highRiskPersonAlert.action.util.Constant.CZZT_DSP%>"type="checkbox"  class="icheckbox czztCheck"name="czzt">待审批</p>
							            <p class="col-xs-1" style="width:150px"><input value="<%= com.taiji.pubsec.szpt.highRiskPersonAlert.action.util.Constant.CZZT_SPTG%>"type="checkbox"  class="icheckbox czztCheck"name="czzt">审批通过</p>
							            <p class="col-xs-1" style="width:150px"><input value="<%= com.taiji.pubsec.szpt.highRiskPersonAlert.action.util.Constant.CZZT_SPBH%>"type="checkbox"  class="icheckbox czztCheck"name="czzt">审批驳回</p>
							</div>
							</div>
							</div>
							</div>
...
<script type="text/javascript"
	src="<%=context%>/scripts/highRiskPersonAlert/personList/personList.js"></script>
</html>