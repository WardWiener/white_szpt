			...
			<div id="c-center-right-content">
				...
				<div class="row row-mar"
					...
					<div class="col-xs-3">
						...
						<button id="snapshot" class="btn btn-primary btn-sm" style="display:none;">生成分析快照</button>
				...
				<div id="nullPerson" style="text-align:center;display:none;margin-top: 50px;">
					<h3>暂无</h3>
				</div>
				...
				<div id="c-center-right-content-block" style="display:none;">
					...
					<div id="c-center-right-content-con">
						<div id="nullTrack" style="text-align:center;display:none;margin-top: 50px;">
							<h3>该人员无轨迹信息</h3>
						</div>
						<div id="trackDiv" class="right-inner" style="margin-left: 280px;display:none;">
									...
									<div class="row row-mar hotel-pannel">
										<table id="countTable1"
											...
											<tbody>
												...
												<tr>
													<td colspan="2"><a data="旅馆酒店"id="hotelAll" class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
													<td colspan="2"><a data="从贵阳乘火车 - 目的地"id="trainOutAll" class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
												</tr>
											</tbody>
										</table>
									</div>
									<div class="row row-mar hotel-pannel">
										<table id="countTable2"
											...
											<tbody>
												...
												<tr>
													<td colspan="2"><a data="网吧"id="internetBarAll"class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
													<td colspan="2"><a data="乘火车到贵阳 - 起始地"id="trainInAll"class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
												</tr>
											</tbody>
										</table>
									</div>
										...
										<table id="countTable3"
											...
											<tbody>
												...
												<tr style="cursor: hand; ">
													<td colspan="2"><a data="监所"id="monitoringGuardAll"class="a-link mar-right-sm" style="cursor :pointer">全部</a></td>
													<td colspan="2"><a data="从贵阳乘飞机- 目的地"id="airPlaneInAll"class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
												</tr>
											</tbody>
										</table>
									...
									<div class="row row-mar hotel-pannel">
										<table id="countTable4"
											...
											<tbody>
												...
												<tr>
													<td colspan="2"><a data="WIFI"id="wifiAll"class="a-link mar-right-sm" style="cursor :pointer">全部</a></td>
													<td colspan="2"><a data="乘飞机到贵阳 - 起始地"id="airPlaneOutAll"class="a-link mar-right-sm all" style="cursor :pointer">全部</a></td>
												</tr>
											</tbody>
										</table>
									</div>
