...
<div class="col-xs-3">
   <div class="col-xs-6"> <label class="control-label">指令状态：</label></div>
    <div class="col-xs-6"><select id="status"class="form-control input-sm select2-noSearch allowClear">
    <option value="">全部</option>
    </select></div>
</div>
<div class="col-xs-3">  
...
<!--悬浮操作层-->
<div class="fixed-a">
<div class="m-ui-title1"><h1>接收指令</h1><div class="m-ui-caozuobox"><button id="add"class="btn btn-primary" style="width:100px">新增指令</button></div>
</div>
</div>
<!--悬浮操作层-->
...
<script type="text/javascript"
	src="<%=context%>/scripts/instruction/instructionReceiveList.js"></script>
<script type="text/javascript"
