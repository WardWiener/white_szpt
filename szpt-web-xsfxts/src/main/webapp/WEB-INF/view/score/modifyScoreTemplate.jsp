...
<body id="cbaGradeTemplate" class="validform m-ui-layer-body">
	<div class="m-ui-layer-box" style="width:800px;">
		<div id="cbaGradeTemplateData" class="m-ui-layer-content">
			<input name="id" type="hidden" class="form-control input-sm form-val">
			<div class="row row-mar">
				<div class="col-xs-2">
					<label class="control-label">模板编码：<span class="red-star">*</span></label>
				</div>
				<div class="col-xs-3">
					<input name="code" class="form-control input-sm valiform-keyup form-val" oldValue="" datatype="*1-80" errormsg="不可超过80个字符">
				</div>
				<div class="col-xs-2">
					<label class="control-label">模板名称：<span class="red-star">*</span></label>
				</div>
				<div class="col-xs-3">
					<input name="name" class="form-control input-sm valiform-keyup form-val" oldValue="" datatype="*1-80" errormsg="不可超过80个字符">
				</div>
			</div>
			<div class="row row-mar">
				<div class="col-xs-2">
			...
			<table id="gradeItemScoreTable" class="table table-bordered table-hover m-ui-table-whole" cellspacing="0">
				...
				<tbody>
					<tr>
						<td>作案特点（手段）相同</td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[0-9](.[0-9]{1,2})?$|^[1][0]$/" errormsg="请输入&lt;=10的小数或整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[1-9]$|^[1][0-9]$|^[2][0-5]$/" errormsg="请输入&gt;0&lt;=25的正整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[2][6-9]$|^[3-4][0-9]$|^[5][0]$/" errormsg="请输入&gt;25&lt;=50的正整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[5][1-9]$|^[6][0-9]$|^[7][0-5]$/" errormsg="请输入&gt;50&lt;=75的正整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[7][6-9]$|^[8-9][0-9]$|^[1][0][0]$/" errormsg="请输入&gt;75&lt;=100的正整数"></td>
					</tr>
					<tr>
						<td>选择处所相同或相似</td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[0-9](.[0-9]{1,2})?$|^[1][0]$/" errormsg="请输入&lt;=10的小数或整数"></td>
					...
					<tr>
						<td>发案社区</td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[0-9](.[0-9]{1,2})?$|^[1][0]$/" errormsg="请输入&lt;=10的小数或整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[1-9]$|^[1-9][0-9]$|^[1][0][0]$/" errormsg="请输入1-100的整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[1-9]$|^[1-9][0-9]$|^[1][0][0]$/" errormsg="请输入1-100的整数"></td>
						<td><input class="form-control input-sm m-inline valiform-keyup" datatype="/^[1-9]$|^[1-9][0-9]$|^[1][0][0]$/" errormsg="请输入1-100的整数"></td>
						<td></td>
					</tr>
...
<script type="text/javascript"
	src="<%=context%>/scripts/score/modifyScoreTemplate.js"></script>
</html>