...
<body>
	...
	<div id="c-center">
		...
		<input id="paraId" type="hidden" value="<%=request.getParameter("id")%>">
					...
					<div class="row">
						...
						<div id="tagValidform" class="validform col-xs-4" style="width: 350px; margin-left: -350px; float: left;">
							...
							<div class="row row-mar">
								...
								<div class="col-xs-7">
									<select id="level" name="level" class="form-control input-sm select2-noSearch valiform-keyup form-val" datatype="*"></select>
								</div>
							</div>
							<div class="row row-mar">
								<div class="col-xs-3">
								...
								<div class="col-xs-7">
									<select id="type" name="type" class="form-control input-sm select2-noSearch valiform-keyup form-val" datatype="*">
							...
							<div class="row row-mar">
								...
								<div class="col-xs-4 ajxzSelect">
									<select id="firstSort" name="firstSort" datatype="*" class="form-control select2-noSearch input-sm valiform-keyup form-val">

									</select>
								</div>
								<div class="col-xs-4 ajxzSelect">
									<select id="secondSort" name="secondSort" class="form-control select2-noSearch input-sm form-val">
							...
							<div class="row row-mar">
								...
								<div class="col-xs-4">
									<select id="placeType" name="placeType" class="form-control input-sm select2-noSearch form-val">
	...
	<script type="text/javascript"    
		src="<%=context%>/scripts/tag/modifyCaseTag.js"></script>
