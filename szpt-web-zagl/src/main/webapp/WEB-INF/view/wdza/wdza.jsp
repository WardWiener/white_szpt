...
<div class="col-xs-3">
   <div class="col-xs-6"> <label class="control-label">涉及子案件：</label></div>
     <div class="col-xs-6 input-group"><input id="sjzaj" value="" type="text" readonly="readonly" class="form-control input-sm"> <span id="sonProject" class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span></div>
</div>
</div>
...
<div class="col-xs-3">
   <div class="col-xs-6"> <label class="control-label">专案组成员：</label></div>
     <div class="col-xs-6 input-group"><input type="text" personId="" readonly="readonly" id="zazcy" value="" class="form-control input-sm"> <span class="input-group-addon" id="findPerson"><span class="glyphicon glyphicon-search"></span></span></div>
</div>
<div class="col-xs-3">  
...
<!--悬浮操作层-->
<div class="fixed-a">
<div class="m-ui-title1"><h1>我的专案</h1><div class="m-ui-caozuobox">
                        <button class="btn btn-danger" style="display: none"  id="stick">置顶</button>
                        <button class="btn btn-danger" style="display: none"  id="nostick">取消置顶</button>
                        <button class="btn btn-primary" id="whMessage" >查看专案基本信息</button>
                         <button class="btn btn-primary" id="involvedBtn" >查看专案涉案人员</button>
                          <button class="btn btn-primary" id="relationBtn">查看人员关系</button>
                        </div></div>
</div>
<!--悬浮操作层-->
...
<script type="text/javascript" src="<%=context%>/script/wdza/wdza.js"></script>
</body>
<style>
		.diyTable-page{
			text-align: right;
