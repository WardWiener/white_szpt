...
<div class="m-ui-title2"><h2>新增专案</h2><div class="m-ui-closebox"><button class="btn m-ui-close" id="closeAdd" ></button></div></div>
<div class="m-ui-layer-content validform" id="yanzhengmingcheng">
...
<div class="col-xs-12"><textarea class="form-control" datatype="*1-80" input-sm" rows="5" id="jyaq" ></textarea></div>
</div> 
<div class="row row-mar">
<p> 目前工作进展情况：</p>
...
<script type="text/javascript" src="<%=context%>/script/zawh/addProject.js"></script>
